                        ...
                        chatHistory.innerHTML = `
                            <div class="flex space-x-3 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700">Hi! Ich bin dein persönlicher Lernassistent. Sprich mit mir oder schreibe mir deine Fragen! Ich werde dir niemals die Lösungen sagen, sondern dir helfen sie selbst zu finden.</p>
                                </div>
                            </div>
                        `;
                    }
